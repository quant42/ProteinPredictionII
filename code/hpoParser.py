...
#  print len(graph.hpoTermsDict)
  sub1 = graph.getHpoSubGraph(["HP:0000153"], {0: {"method":"-", "hit_id": "hit1", "hit_value":"-"}})
  sub1.writeSvgImage(fileName="p1.svg")
  #sub2 = graph.getHpoSubGraph(["HP:0002813"], {2: {"method":"-", "hit_id": "hit2", "hit_value":"-"}})
  #sub2.writeSvgImage(fileName="p2.svg")
  #g = (sub1 + sub2)
  #g.writeSvgImage(fileName="g.svg")
