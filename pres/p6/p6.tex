...
\begin{frame}
	...
	%first hidden level
	\node[draw, circle] (h11) at (2,4.5){$h_{11}$};
	\node[draw, circle] (h12) at (2,3.5){$h_{12}$};
	\node[draw, circle] (h13) at (2,2.5){$h_{13}$};
	\node[] at (2,0.5){$\vdots$};
	\node[] (h1n) at (2,-1){$h_{1(n+1)}$};	
	
	%second hidden level
	\node[draw, circle] (h21) at (4,2.5){$h_{21}$};
	\node[draw, circle] (h22) at (4,1.5){$h_{22}$};
	\node[draw, circle] (h23) at (4,0.5){$h_{23}$};
